            ...
            <header className="bg-gray-900 text-white py-4">
                <div className="container mx-auto px-4 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <a href="#" className="font-bold text-xl">ONE ESPORTS</a>
                        <nav className="hidden md:flex space-x-4">
                            <a href="#" className="hover:text-yellow-400">LMHT</a>
                            <a href="#" className="hover:text-yellow-400">LIÊN QUÂN MOBILE</a>
                            <a href="#" className="hover:text-yellow-400">DTCL</a>
                            <a href="#" className="hover:text-yellow-400">VALORANT</a>
                            <a href="#" className="hover:text-yellow-400">PUBG</a>
                            <a href="#" className="hover:text-yellow-400">THẾ GIỚI GAME</a>
                            <a href="#" className="hover:text-yellow-400">EA SPORTS FC</a>
                        </nav>
                    </div>
                    <div className="flex items-center space-x-2">
                        <button className="bg-yellow-500 text-black px-3 py-1 rounded font-bold">ĐĂNG NHẬP</button>
                    </div>
                </div>
            </header>
